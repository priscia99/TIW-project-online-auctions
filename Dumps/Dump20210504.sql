...
CREATE TABLE `auction` (
  ...
  CONSTRAINT `id_seller` FOREIGN KEY (`id_seller`) REFERENCES `user` (`id`) ON UPDATE CASCADE
...
CREATE TABLE `bid` (
  ...
  CONSTRAINT `id_bidder` FOREIGN KEY (`id_bidder`) REFERENCES `user` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-05-04 18:32:25
